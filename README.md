...
**Archive**: Though our repo follows a decoupled design, we try to provide more functionalities of Rust analysis by releasing projects separately. In this case, we will not update this big project, but update this in another organization called [Rust Hell](https://github.com/Rust-Hell), and this repo is reorganized as [RUF-Research](https://github.com/Rust-Hell/RUF-Research.git).
