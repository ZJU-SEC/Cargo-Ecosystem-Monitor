// File from Crago::ops::tree

use cargo::ops::tree::{TreeOptions, Target, EdgeKind};
...
#[derive(Debug, Clone)]
pub struct Edges(pub HashMap<EdgeKind, Vec<usize>>);
...
pub fn build<'a>(
    ...
    // println!("members_with_features: {:#?}", members_with_features);
...
fn add_pkg(
    ...
    let show_all_targets = opts.target == Target::All;
